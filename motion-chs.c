/* motion benchmark from e.g. legup-4.0/examples/chstone/motion/*.c
...
int motion_read (unsigned char *s1, const unsigned char *s2, int n)
{
  unsigned char *p1;
...
void Fill_Buffer ()
{
  ...
  Buffer_Level = motion_read (ld_Rdbfr, inRdbfr, 2048);
  ld_Rdptr = ld_Rdbfr;
...
void motion_vectors (PMV, dmvector, motion_vertical_field_select, s,
...
/* get and decode motion vector and differential motion vector 
   for one prediction */
void motion_vector (PMV, dmvector, h_r_size, v_r_size, dmv, mvscale,
               full_pel_vector)
     int *PMV;
     int *dmvector;
     int h_r_size;
...
static void decode_motion_vector (pred, r_size, motion_code, motion_residual,
                      full_pel_vector)
     int *pred;
